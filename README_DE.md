...
Allerdings hat sich gezeigt, dass der Windgeschwindigkeitssensor zu geringe Windgeschwindigkeiten misst - ein Problem dass [andere](https://groups.google.com/forum/#!topic/wview/ApDfFduWKn8) auch hatten und gelöst haben, indem sie das minderwertige Original-Kugellager durch ein hochwertiges __Keramik-Kugellager__ ersetzt haben. Das Kugellager muss einen Aussendurchmesser von 10mm und einen Innendurchmesser von 5mm haben. Ich habe ein [Schmuhmacher U2862 Cermaic Bearing 5x10x4 Shielded (pr)](http://www.racing-cars.com/pp/Old_Cars_and_Parts/Fusion_21/U2698.html) verwendet, das eigentlich für Modellrennwagen gedacht ist.
...
## Luftdruck
Für die Messung des Luftdrucks verwende ich einen [MPL3115A2](http://www.nxp.com/files/sensors/doc/data_sheet/MPL3115A2.pdf), den es auch auf einem [Breakout-Board mit integrierten Pull-Up-Widerständen](http://www.berlinsensorik.de/web/index.php?id=mpl3115a2) gibt. Ursprünglich wollte ich diesen Sensor auch im Stevenson-Screen installieren, aber ich musste feststellen, dass bei Leitungslängen größer 1 Meter das I2C-Protokoll nicht immer funktioniert und der Arduino nicht mit dem Sensor kommunizieren kann. Deshalb ist der Sensor mit einem ca. 50cm lange Kabel mit dem Arduino verbunden. Auch hier habe ich alle Kontakte auf dem Breakout-Board mit Heisskleber ummantelt.
